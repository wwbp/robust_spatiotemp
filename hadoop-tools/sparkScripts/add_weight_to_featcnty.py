'''
run as
~/spark/bin/spark-submit --conf spark.executor.memory=7G --jars ~/hadoop-tools/jars/hadoop-lzo-0.4.21-SNAPSHOT.jar ~/hadoop-tools/sparkScripts/add_weight_to_featcnty.py
'''
...
# 2019
DEF_INPUTFILE    = "/hadoop_data/ctlb/2019/feats/featANS.dd_daa_c2adpt_ans_nos.timelines2019_lex_3upts.yw_user_id.cnty"
DEF_MAPPING_FILE = "/home/smangalik/post_strat_weights/users_2019/yw_user_2019_weights_income_k10_mbn50.csv" 

# 2020
#DEF_INPUTFILE    = "/hadoop_data/ctlb/2020/feats/featANS.dd_daa_c2adpt_ans_nos.timelines2020_lex_3upts.yw_user_id.cnty"
#DEF_MAPPING_FILE = "/home/smangalik/post_strat_weights/users_2020/yw_user_2020_weights_income_k10_mbn50.csv" 

DEF_OUTPUTFILE   = DEF_INPUTFILE + ".wt" + "50"
...
output_file         = args.output_file # + "50"
...
for i, ywuser_set in enumerate(ywuser_sets):
    ...
    iter_result.toDF().write.csv(iter_result_file) # From DataFrame
