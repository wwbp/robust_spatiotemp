...
### 3. Account-level, time scoring   
  - Word extraction
    ...
    - `./runThis INPUT OUTPUT MESSAGE_FIELD GROUP_ID N` 
      ...
      - ex.`./runThis.sh /hadoop_data/ctlb/2020/feats/timelines2020_full_3upts.csv /hadoop_data/ctlb/2020/feats/feat.1gram.timelines2020_full_3upts.yw_user_id 3 0 1` OUTPUT: `/hadoop_data/....`
